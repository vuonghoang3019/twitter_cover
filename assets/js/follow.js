$(function(){
    $('.follow-btn').click(function(){
        ...
        {                                                              
            $.post('http://localhost:81/twitter/core/ajax/follow.php',{unfollow:followID, profile:profile}, function(data){
        ...
        {
            $.post('http://localhost:81/twitter/core/ajax/follow.php',{follow:followID, profile:profile}, function(data){
                data = JSON.parse(data);
