...
class Tweet extends User
{
    ...
    {
        $stmt = $this->pdo->prepare("SELECT * FROM tweets  JOIN users ON tweetBy = user_id WHERE tweetBy = :user_id AND retweetID = '0' OR tweetBy = user_id AND retweetBy != :user_id  AND tweetBy IN(SELECT receiver FROM follow WHERE sender = :user_id) ORDER BY tweetID DESC LIMIT :num ");
        ...
        foreach ($tweets as $tweet)
        {
            ...
            echo '<div class="all-tweet">
                    ...
                    '.((isset($retweet['retweetID']) === $tweet->retweetID || $tweet->retweetID > 0) ? '
                        <div class="t-show-banner">
                            <div class="t-show-banner-inner">
                                <span><i class="fa fa-retweet" aria-hidden="true"></i></span><span>'.$user->screenName.'</span>
                            </div>
                        </div>' : '').'
                        ...
                        <div class="t-s-head-content">
                            <div class="t-h-c-name">
                                ...
                                <span>'.$this->timeAgo(isset($retweet['postedOn'])).'</span>
                            </div>
                            <div class="t-h-c-dis">
                    ...
                    <div class="t-s-b-inner">
                        <div class="t-s-b-inner-in">
                            ...
                            '.((!empty($tweet->tweetImage)) ? '
                                ...
                                <div>
                                    <div class="t-h-c-name">
                                        <span><a href="'.BASE_URL.$user->screenName.'">'.$tweet->screenName.'</a></span>
                                        <span>@'.$user->username.'</span>
                        ...
                        <div class="t-show-footer">
                            <div class="t-s-f-right">
                                <ul> 
                                    ...
                                    <li>'.(($tweet->tweetID === isset($retweet['retweetID'])) ? 
