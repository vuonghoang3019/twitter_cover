                                        ...
                                        <div class="tweet-show-popup-comment-head">
                                            ...
                                            <div class="tweet-show-popup-comment-head-right">
                                                ...
                                                <div class="tweet-show-popup-comment-right-tweet">
                                                        <p><a href="'.BASE_URL.$comment->username.'">@'.$tweet->username.'</a> '.$comment->comment.'</p>
                                                </div>
                                                <div class="tweet-show-popup-footer-menu">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul> 
                                                                <li>
                                                                    <label class="deleteComment" data-tweet="'.$tweet->tweetID.'" data-comment="'.$comment->commentID.'">Delete Tweet</label>
                                                                </li>
                                                            </ul>
                                                        </li>' : '').'
                                                    </ul>
