<?php 
    ...
    if(isset($_GET['hashtag']) && !empty($_GET['hashtag']))
    {
		...
		$account = $getFromT->getUsersByHash($hashtag);
	...
	<div class="nav-container">
		...
		<div class="nav-right">
			<ul>
				...
				<?php } else{
					echo '<li><a href="<?php echo BASE_URL ?>index.php">Have an account? Log in</a></li>';
				} ?>
			</ul>
		</div><!-- nav right ends-->
	...
	<div class="follow-unfollow-inner">
		...
		<div class="follow-person-bio">
			<div class="follow-person-name">
				<a href="<?php echo BASE_URL.$users->screenName ?>"><?php echo $users->screenName ?></a>
			</div>
