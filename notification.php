<?php 
	...
	$notifications = $getFromM->notification($user_id);
		...
		<div class="in-center">
			<div class="in-center-wrap">
                ...
                <div class="notification-inner">
                    <div class="notification-header">
                        ...
                        <div class="notification-name">
                            <div>
                                <img src="<?php BASE_URL.$data->profileImage ?>"/>
                            </div>
                        
                        </div>
                        <div class="notification-tweet"> 
                        <a href="<?php echo BASE_URL.$data->username ?>" class="notifi-name"><?php echo BASE_URL.$data->screenName ?></a><span> Followed you your - <span><?php $getFromU->timeAgo($data->time) ?></span>
                ...
                <div class="notification-inner">
                    ...
                    <div class="notification-tweet"> 
                        <a href="<?php echo BASE_URL.$data->username ?>" class="notifi-name"><?php echo $data->screenName ?></a><span> liked your <?php if($data->tweetBy == $user_id) {echo 'Tweet';} else {echo 'Retweet';} ?> - <span><?php $getFromU->timeAgo($data->time) ?></span>
                    </div>
                        ...
                        <div class="noti-footer-inner">
                            <div class="noti-footer-inner-left">
                                <div class="t-h-c-name">
                                    ...
                                    <span>@<?php echo $user->screenName ?></span>
                ...
                <div class="notification-inner">
                    ...
                    <div class="notification-tweet"> 
                        <a href="<?php echo BASE_URL.$data->username ?>" class="notifi-name"><?php echo BASE_URL.$data->screenName ?></a><span> retweet your <?php if($data->tweetBy === $user_id) {echo 'Tweet';} else {echo 'Retweet';} ?> - <span><?php $getFromU->timeAgo($data->time) ?></span>
                    </div>
                    <div class="notification-footer">
                        <div class="noti-footer-inner">
                            ...
                            <div class="noti-footer-inner-left">
                                <div class="t-h-c-name">
                                    <span><a href="<?php echo BASE_URL.$user->profileImage ?>"><?php echo $user->screenName ?></a></span>
                                    <span>@<?php echo $user->username ?></span>
                                    <span><?php $getFromU->timeAgo($data->postedOn) ?></span>
                                </div>
                                <div class="noti-footer-inner-right-text">		
                                    <?php $getFromT->getTweetLinks($data->status) ?>
                                </div>
                            </div>
									...
									<div class="t-show-footer">
										<div class="t-s-f-right">
											...
											'.(($getFromU->loggedIn() === true) ? '
												...
												<li>'.(($tweet->tweetID === isset($retweet['retweetID']) ||  $user_id == isset($retweet['retweetBy'])) ? 
												...
												<li>'.((isset($likes['likeOn']) === $tweet->tweetID) ? 
